...
<html class="no-js" lang="en">
    ...
    <main>
        ...
        <!--------- Section START ---------->
        <section class="banner_area "  data-aos="fade-up" style="background-image: url(./assets/img/lnlrestaurantAbout.jpg);">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
        ...
        <!--------- Section START ---------->
        <section class=" Menus-area sec__padding" data-aos="fade-up" >
            <div class="container">
                ...
                <div class="row MenusAllItems">
                    ...
                    <div class="col-lg-6" data-item="e-ckn">
                        <div class="item__blk">
                            ...
                            <div class="itemblk__text">
                                <div class="itemblk__title">
                                    <h2>Tandoor Mixed Grill Platter
                                    </h2>
                                    <span>$ 24.99</span>
                                </div>
                                <p></p>
                    ...
                    <div class="col-lg-6" data-item="e-lamb">
                        ...
                        <div class="itemblk__text">
                            <div class="itemblk__title">
                                <h2>Tandoori Machhalee (Grilled Fish)
                                    </h2>
                                <span>$ 16.99</span>
                            </div>
                            <p>Samosa is an amazing and mouthwatering Indian appetizer made with a spiced potatoes filling. It's a popular street food in India. The filling is wrapped using Samosa wrappers into triangle cone shapes. They are</p>
                    ...
                    <div class="col-lg-6" data-item="corn">
                        <div class="item__blk">
                            ...
                            <div class="itemblk__text">
                                <div class="itemblk__title">
                                    <h2>Grilled Mahi Mahi
                                    </h2>
                                    <span>$ 23.99</span>
                                </div>
                                <p>
                                    Mahi Mahi fillet marinated with a mixture of tandoor spices and herbs.
                    ...
                    <div class="col-lg-6" data-item="e-seafood">
                        ...
                        <div class="itemblk__text">
                            <div class="itemblk__title">
                                <h2>Hyderabad Chicken Dum Biryani
                                </h2>
                                <span>$ 16.99</span>
                            </div>
                            <p></p>
                    ...
                    <div class="col-lg-6" data-item="e-seafood">
                        <div class="item__blk">
                            ...
                            <div class="itemblk__text">
                                <div class="itemblk__title">
                                    <h2>Hong Kong Chicken Fried Rice
                                    </h2>
                                    <span>$ 16.99</span>
                                </div>
                    ...
                    <div class="col-lg-6" data-item="e-seafood">
                        ...
                        <div class="itemblk__text">
                            <div class="itemblk__title">
                                <h2>Hong Kong Shrimp Fried Rice
                                </h2>
                                <span>$ 18.99</span>
                            </div>
